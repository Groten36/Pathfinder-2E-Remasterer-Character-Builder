...
class StandardAttributeFactory(AbstractAttributeFactory):

    def create_strength(self) -> Strength: return Strength(10)
    def create_dexterity(self) -> Dexterity: return Dexterity(10)
    ...
    def create_charisma(self) -> Charisma: return Charisma(10)